"""Smoke tests for the P3 training (10_train) and background-sampling (15_background) scripts."""
...
def test_fit_heads_returns_three_boosters():
    """Verify fit_heads returns exactly the three modality heads and that fused head produces correct output shape."""
...
def test_sample_background_shapes():
    """Verify sample_background returns arrays of the requested size and is deterministic under a fixed seed."""
